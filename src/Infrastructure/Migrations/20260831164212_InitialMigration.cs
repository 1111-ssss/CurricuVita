        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SvgTemplate = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageValue = table.Column<string>(type: "text", nullable: true),
                    ...
                    PeriodStartValue = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    PeriodEndValue = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PositionId = table.Column<int>(type: "integer", nullable: false),
                    AttributeDefinitionId = table.Column<int>(type: "integer", nullable: false),
                    Operator = table.Column<int>(type: "integer", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_CVId_RecruiterId",
                table: "Likes",
